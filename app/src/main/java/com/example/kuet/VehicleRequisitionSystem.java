...
public class VehicleRequisitionSystem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://portal.kuet.ac.bd/vehicle/");
    }
...
class CustomWebViewClientaehVRS extends WebViewClient {

    private Activity activity;

    public CustomWebViewClientaehVRS(Activity activity){
