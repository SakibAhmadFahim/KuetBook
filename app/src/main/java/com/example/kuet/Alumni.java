...
public class Alumni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://portal.kuet.ac.bd/kuetaa/");
    }
...
class CustomWebViewClientaehAlumni extends WebViewClient {

    private Activity activity;

    public CustomWebViewClientaehAlumni(Activity activity){
